...
class _SaleState extends State<Sale>
                ...
                return Padding(
                  ...
                  child: GestureDetector(
                    onTap: () {
                      ...
                      print("data before sending ${jsonEncode(recentSearchModel!.date![index])}");
  ...
  callChat(index) async {
    ...
    var otherUser1 = types.User(
      ...
      id: recentSearchModel!.date![index].fuid.toString(),
  ...
  _handlePressed( types.User otherUser, BuildContext context, String fcmID, Date model) async {
    if(fcmID == null || fcmID == ""){
      print("fuid is null");
      setState(() {
        chatLoading = false;
